...
DROP TABLE IF EXISTS `restaurant_stuff`;
...
LOCK TABLES `restaurant_stuff` WRITE;
/*!40000 ALTER TABLE `restaurant_stuff` DISABLE KEYS */;
INSERT INTO `restaurant_stuff` VALUES (2,'souravsantra@test.com','sourav santra');
/*!40000 ALTER TABLE `restaurant_stuff` ENABLE KEYS */;
UNLOCK TABLES;
